export const webDesign = [
  ...
  //   desc: "",
  //   imgs: [
  //     "./assets/projects/webDesign/responsiveDesign/responsiveDesign-1.PNG",
  //     "./assets/projects/webDesign/responsiveDesign/responsiveDesign-2.PNG",
  //     "./assets/projects/webDesign/responsiveDesign/responsiveDesign-3.png",
  //     "./assets/projects/webDesign/responsiveDesign/responsiveDesign-4.png",
  //     "./assets/projects/webDesign/responsiveDesign/responsiveDesign-5.gif",
  //   ],
  ...
  //   desc: "",
  //   imgs: [
  //     "./assets/projects/webDesign/pseudoClass/pseudoClass-1.png",
  //     "./assets/projects/webDesign/pseudoClass/pseudoClass-2.gif",
  //   ],
  ...
  //   desc: "",
  //   imgs: [
  //     "./assets/projects/webDesign/htmlForm/htmlForm-1.png",
  //     "./assets/projects/webDesign/htmlForm/htmlForm-2.gif",
  //   ],
  ...
  //   desc: "",
  //   imgs: [
  //     "./assets/projects/webDesign/embed/embed-1.png",
  //     "./assets/projects/webDesign/embed/embed-2.gif",
  //   ],
  ...
  //   desc: "",
  //   imgs: [
  //     "./assets/projects/webDesign/gridFramework/gridFramework-1.png",
  //     "./assets/projects/webDesign/gridFramework/gridFramework-2.gif",
  //   ],
  ...
  //   desc: "",
  //   imgs: ["./assets/projects/webDesign/gradient/gradient-1.png"],
...
export const reactPortfolio = [
  {
    ...
    imgs: [
      { id: "img-1", src: "./assets/projects/react/instagram/instagram-1.PNG" },
      { id: "img-2", src: "./assets/projects/react/instagram/instagram-2.png" },
      { id: "img-3", src: "./assets/projects/react/instagram/instagram-3.PNG" },
      { id: "img-4", src: "./assets/projects/react/instagram/instagram-4.gif" },
      { id: "img-5", src: "./assets/projects/react/instagram/instagram-5.gif" },
      { id: "img-6", src: "./assets/projects/react/instagram/instagram-6.gif" },
    ],
...
export const gamesPortfolio = [
  ...
  //   id: "4",
  //   icon: [
  //     { id: "1", icon: "./assets/javascript.png", color: "javascript" },
  //     { id: "2", icon: "./assets/html.png", color: "html" },
  //     { id: "3", icon: "./assets/css.png", color: "css" },
  //   ],
  //   title: "Tic Tac Toe",
  ...
  //     "./assets/projects/react/gameNseek/gameNseek-2.png",
  //   ],
  //   repository: "https://github.com/KFig21/tic_tac_toe",
  //   live: "https://kfig21.github.io/tic_tac_toe/",
  // },
  // {
  //   id: "5",
  //   icon: [
