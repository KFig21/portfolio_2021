export const projectData = [
  {
    id: "1",
    icon: [
      { icon: "./assets/react.png", color: "react" },
      { icon: "./assets/tailwind.png", color: "tailwind" },
      { icon: "./assets/firebase.png", color: "firebase" },
    ],
  ...
  },
  {
    ...
    icon: [
      { icon: "./assets/react.png", color: "react" },
      { icon: "./assets/javascript.png", color: "javascript" },
      { icon: "./assets/css.png", color: "css" },
    ],
    title: "HoopShop",
    desc: "Lorem Ipsum is simply dummy text of the printing and typesetting industry.",
    img: "./assets/hoopShopPic1.PNG",
